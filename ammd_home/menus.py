...
from ammd.settings import (
    EXPLORE_EXAMPLE_MENU_NAME,
    EXPLORE_MENU_NAME,
    EXPLORE_TREE_MENU_NAME,
    VISUALIZATION_USER_MENU_NAME,
    CURATE_MENU_NAME,
    SCHEMA_VIEWER_MENU_NAME,
...
Menu.add_item(
    "advanced",
    MenuItem(VISUALIZATION_USER_MENU_NAME, reverse("core_visualization_index")),
)
Menu.add_item(
    "admin",
    MenuItem("VISITS COUNTER", reverse("get_visits_number"), icon="tachometer-alt"),
)
Menu.add_item(
    "advanced",
    MenuItem(
        VISUALIZATION_INSITU_USER_MENU_NAME, reverse("core_visualization_insitu_index")
    ),
)
